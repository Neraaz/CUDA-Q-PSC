...
singularity exec --cleanenv --no-home --nv --bind $PWD/openfermion_data:/usr/local/lib/python3.10/dist-packages/openfermion/testing/data /work/08910/nnepal/vista/GHTEST_1/cuda-quantum.sif mpiexec -np 2 python3 vqe-test.py
