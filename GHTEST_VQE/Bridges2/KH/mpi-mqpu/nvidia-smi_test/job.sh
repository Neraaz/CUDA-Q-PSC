...
#SBATCH -t 2:30:00             # Max time for the job
...
singularity exec --cleanenv --nv --no-home --bind $PWD/openfermion_data:/usr/local/lib/python3.10/dist-packages/openfermion/testing/data /jet/home/nnepal/tests/cudaq_test/GHTEST_1/cuda-quantum.sif python3 vqe-test.py &
